...
# PyroClient Setup 
API_ID = int(environ['API_ID','23580732'])
API_HASH = environ['API_HASH','81ca3df48f25d954b2ebef5aec715a73']
BOT_TOKEN = environ['BOT_TOKEN','7798556356:AAG3hLCsWJfKmWm8AoQ7hs-Z3_pM8sy2u4g']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002470891127').split()]
